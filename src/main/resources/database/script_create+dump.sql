...
INSERT INTO "user" (username, email, password_hash, role, is_banned, game_win_count, game_lose_count, game_count, coins_total)
VALUES 
('user1', 'user1@gmail.com', 'password1', 'PLAYER', FALSE, 0, 0, 0, 0),
